...
const db=admin.firestore();exports.handler=async function(e,t){if("POST"!==e.httpMethod)return{statusCode:405,body:"Method Not Allowed"};try{const t=JSON.parse(e.body),r=await db.collection("dailyUpdates").add(t);return{statusCode:200,body:JSON.stringify({id:r.id})}}catch(e){return console.error(e),{statusCode:500,body:JSON.stringify({error:"Failed to add update"})}}};
